      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center bg-white/5 border border-white/10 rounded-xl p-1.5 gap-1 backdrop-blur-md">
            <a href="#tracks" className="font-sans font-medium text-[13px] text-gray-300 hover:text-white hover:bg-white/5 px-4 py-2 rounded-lg transition-all tracking-wide">About</a>
