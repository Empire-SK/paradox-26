  ...
  return (
    <header className="fixed top-0 left-1/2 -translate-x-1/2 z-50 mt-4 w-[96%] max-w-[1000px]">
      <div className="glass-panel px-6 py-3 rounded-xl flex items-center justify-between shadow-lg shadow-black/50 border-b border-[var(--color-tech-primary)]/30">
        ...
        <button className="hidden md:flex tech-btn group !px-6 !py-2 !text-[10px]">
          REGISTER NOW
      ...
      {isOpen && (
        <div className="md:hidden glass-panel mt-2 p-4 rounded-xl flex flex-col gap-4 border border-[var(--color-tech-primary)]/20 animate-in fade-in slide-in-from-top-2 duration-300">
